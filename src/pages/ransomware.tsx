...
export default function DNSAlert() {
  const [data, setData] = useState<Array<ransomwareAlertType>>([]);

  useEffect(() => {
    axios
      .get(
        "http://backend-env.eba-gt2wrdmr.ap-south-1.elasticbeanstalk.com/ransomwareAlerts"
      )
                ...
                <tbody>
                  {data.map((i) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-2 text-center">{i?.message}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
